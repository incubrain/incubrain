      ...
      <div class="w-full">
        ...
        <div class="flex flex-col lg:flex-row mx-auto w-full bg-white dark:bg-gray-800 shadow rounded">
          <div class="w-full lg:w-1/3 p-6">
            ...
            <h3 class="text-lg text-gray-800 dark:text-gray-100 font-bold mt-5 mb-1">
          ...
          >
            ...
            <div class="mt-6 mb-8 w-full bg-gray-100 dark:bg-gray-700 rounded p-4 relative">
              <ul>
                <li class="text-xs text-gray-600 dark:text-gray-400 font-normal tracking-normal">
                  - Visual QA for all design components
                </li>
                <li class="text-xs text-gray-600 dark:text-gray-400 font-normal tracking-normal my-4">
            ...
            <div class="flex items-center justify-between">
              <div>
                <h2 class="text-gray-600 dark:text-gray-400 font-bold text-lg leading-6 mb-1 text-center">
                  24
                </h2>
                <p class="text-gray-800 dark:text-gray-100 text-sm leading-5 text-center">
                  Milestones
                </p>
              </div>
              <div>
          ...
          <div class="w-full lg:w-1/3 p-6">
            <div class="mb-4 flex items-center justify-between">
              <p class="text-gray-600 dark:text-gray-400 text-sm font-normal leading-3 tracking-normal">
                User Experience Research
              </p>
              <p class="text-xs text-indigo-700 dark:text-indigo-600 font-normal leading-3 tracking-normal">
                7/12
              </p>
            </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                <p class="text-sm text-gray-800 dark:text-gray-100 font-normal mb-1 tracking-normal">
                  Earnings
                </p>
                <h2 class="text-sm xl:text-lg text-gray-600 dark:text-gray-400 font-bold tracking-normal">
                  $357,655
                </h2>
              </div>
              <div>
