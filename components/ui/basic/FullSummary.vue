      ...
      <div class="w-full">
        ...
        <div class="mx-auto w-full p-5 lg:p-10 bg-white dark:bg-gray-800 shadow rounded">
          <div class="flex flex-col lg:flex-row items-start lg:items-center mb-8">
            <h1 class="mr-12 text-xl lg:text-2xl text-gray-800 dark:text-gray-100 font-bold lg:w-1/2">
              User Experience Revamp and Optimization
            </h1>
            <div class="flex flex-col md:flex-row items-start md:items-center">
              <div class="mt-4 lg:mt-0 mr-0 xl:mr-8 text-sm bg-indigo-100 text-indigo-700 dark:text-indigo-600 rounded font-medium py-2 w-48 flex justify-center">
                Start Date: 22 Jun, 2020
              </div>
              <div class="mt-4 lg:mt-0 mr-0 lg:mr-4 xl:mr-8 text-sm bg-red-100 text-red-500 rounded font-medium py-2 w-48 flex justify-center">
          ...
          <div class="flex flex-col lg:flex-row items-start lg:items-center">
            ...
            <div class="lg:pl-8 w-full lg:w-1/2 flex flex-col lg:flex-row items-start lg:items-center">
              <div class="mr-12 flex lg:block items-center lg:mr-6 xl:mr-12 mt-5 lg:mt-0">
                <h2 class="text-gray-600 dark:text-gray-400 font-bold text-xl lg:text-2xl leading-6 mb-1 lg:text-center">
                  24
                </h2>
          ...
          <div class="flex flex-col lg:flex-row items-start lg:items-center">
            <div class="flex flex-col lg:flex-row w-full lg:w-2/3 items-start lg:items-center mb-8 lg:mb-0">
              <div class="mr-24 flex lg:block flex-row-reverse items-center mb-4 lg:mb-0">
                <h3 class="text-indigo-700 dark:text-indigo-600 leading-6 text-lg">
                  Earnings
                </h3>
                <h2 class="mr-2 lg:mr-0 text-gray-600 dark:text-gray-400 text-xl lg:text-2xl font-bold">
                  $357,655
                </h2>
              </div>
              <div class="mr-24 flex lg:block flex-row-reverse items-center mb-4 lg:mb-0">
