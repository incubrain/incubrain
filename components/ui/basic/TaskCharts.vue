<template>
  <div class="flex items-top justify-center w-full h-auto">
    <div class="max-w-sm w-full bg-white dark:bg-gray-800 shadow rounded px-8 py-6">
      <div class="flex items-center justify-between">
        <div>
          <p class="sm:text-2xl text-xl font-semibold leading-6 text-gray-800 dark:text-gray-100">
            12d 23hrs
          </p>
      ...
      <div class="mt-6">
        <div>
          <div class="flex items-center justify-between">
            ...
            <p class="text-base leading-3 text-right text-gray-800 dark:text-gray-100">
              60%
            </p>
          </div>
          <div class="w-full h-1 bg-gray-200 rounded-full mt-4">
            <div class="w-1/2 h-1 bg-green-500 rounded-full" />
          </div>
        </div>
        <div class="mt-6">
          <div class="flex items-center justify-between">
          ...
          <div class="w-full h-1 bg-gray-200 rounded-full mt-4">
            <div class="w-1/6 h-1 bg-pink-500 rounded-full" />
          </div>
        </div>
        <div class="mt-6">
          <div class="flex items-center justify-between">
          ...
          <div class="w-full h-1 bg-gray-200 rounded-full mt-4">
            <div class="w-2/5 h-1 bg-yellow-500 rounded-full" />
          </div>
        </div>
      </div>
      <p class="text-xs font-semibold leading-3 text-indigo-700 mt-6">
        Manage project
      </p>
    </div>
  </div>
