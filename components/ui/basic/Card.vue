  ...
  <div class="flex flex-col-reverse lg:flex-row w-full bg-white dark:bg-gray-800 shadow rounded">
    <div class="w-full">
      <div class="pt-4 lg:pt-6 pb-4 lg:pb-6 pl-4 lg:pl-6 pr-4 lg:pr-6">
        ...
        <h2 class="text-gray-800 dark:text-gray-100 mt-4 mb-2 tracking-normal text-xl lg:text-2xl font-bold">
          CES - The Global Stage for Innovation
        </h2>
        <p class="mb-6 font-normal text-gray-600 dark:text-gray-400 text-sm tracking-normal w-11/12 lg:w-9/12">
          The Consumer Technology Association’s CES 2020 will take place on 7-10 January at the Las Vegas Convention Center in Nevada. It will bring together over 150,000 delegates and 4,500 exhibitors to explore the business of consumer technologies.
        </p>
        <div class="flex lg:items-center items-start flex-col lg:flex-row">
          <div class="flex items-center">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-xs font-normal ml-1">
              +12 Attendees
            </p>
          </div>
          <div class="mt-4 lg:mt-0 ml-0 lg:ml-12 flex items-end">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-sm tracking-normal font-normal text-center">
              Las Vegas, Nevada
            </p>
          </div>
        </div>
        ...
        <div class="flex items-center">
          <div class="flex items-center">
            <div class="bg-white rounded-full w-5 h-5 flex flex-shrink-0 justify-center items-center relative">
              ...
              <div class="check-icon hidden border-4 border-black dark:border-gray-700 rounded-full w-full h-full z-1" />
            </div>
            <p class="ml-3 text-base leading-4 font-normal text-gray-800 dark:text-gray-100">
              Going
            </p>
          </div>
