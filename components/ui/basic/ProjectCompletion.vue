    ...
    <div class="flex items-center justify-center w-full h-full py-12 px-4">
      <div class="bg-white dark:bg-gray-800 rounded shadow max-w-xl py-6 sm:px-8 px-4">
        <div class="flex items-center justify-between">
          <p class="text-base sm:text-2xl font-semibold leading-4 text-gray-800 dark:text-gray-100">
            Complete Analysis
          </p>
          <div class="relative">
            <button class="focus:outline-none">
              <svg
                class="dropbtn dark:text-gray-100 text-gray-800"
        ...
        <p class="text-sm leading-5 mt-4 text-gray-500 dark:text-gray-400 sm:w-10/12">
          Every large design company whether it’s a multi-national branding corporation or a regular.
        </p>
        <div class="mt-8">
          <div class="flex flex-col justify-end">
            <p class="text-sm font-semibold leading-none text-right text-gray-500 dark:text-gray-400">
              80% complete
            </p>
            <div class="bg-green-50 rounded-full mt-3 h-2 w-full">
              <div class="bg-green-500 w-5/6 h-2 rounded-full" />
            </div>
          </div>
