          ...
          <table class="w-full whitespace-nowrap">
            <tbody>
              ...
              <tr tabindex="0" class="focus:outline-none  h-16 border border-gray-100 rounded">
                ...
                <td class="pl-5">
                  <button class="py-3 px-6 focus:outline-none text-sm leading-none text-gray-700 bg-gray-100 rounded">
                    Due on 21.02.21
                  </button>
                </td>
                <td class="pl-4">
              ...
              <tr tabindex="0" class="focus:outline-none focus:text-indigo-600 h-16 border border-gray-100 rounded">
                ...
                <td class="pl-5">
                  <button class="py-3 px-7 text-sm leading-none text-gray-700 bg-gray-100 rounded focus:outline-none">
                    Due tomorrow
                  </button>
                </td>
                <td class="pl-4">
              ...
              <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                ...
                <td class="pl-5">
                  <button class="py-3 px-3 text-sm leading-none text-red-700 bg-red-100 rounded focus:outline-none">
                    Due Today at 18:00
                  </button>
                </td>
                <td class="pl-4">
              ...
              <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                ...
                <td class="pl-5">
                  <button class="py-3 px-3 text-sm leading-none text-gray-700 bg-gray-100 hover:bg-gray-200 rounded focus:outline-none">
                    Due Today at 18:00
                  </button>
                </td>
                <td class="pl-4">
