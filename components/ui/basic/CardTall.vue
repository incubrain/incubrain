  ...
  <div>
    <div class="max-w-sm w-full relative rounded shadow bg-white dark:bg-gray-800">
      ...
      <div class="py-4 px-6">
        ...
        <p class="sm:text-xl text-lg font-bold pt-4 leading-10 text-gray-800">
          Lorem ipsum dolor
        </p>
        <p class="sm:text-base text-sm leading-5 text-gray-500 pt-3">
          Proin mattis nec odio et pharetra. Mauris ut odio finibus, mollis elit ac, fermentum lacus. Quisque eleifend ac nunc id tristique. Phasellus a risus quis nulla cursus placerat ac at lectus. Pellentesque porta.
        </p>
      </div>
      <div class="border-t-2 mt-4 border-gray-200">
        <div class="px-6 py-4 flex items-center justify-between">
          <p class="text-sm leading-4 text-indigo-700">
            Learn More
          </p>
          <div class="flex items-center">
            <div class="flex items-center justify-between">
              ...
              <p class="sm:text-lg text-sm leading-4 text-gray-500 ml-3">
                14
              </p>
            </div>
