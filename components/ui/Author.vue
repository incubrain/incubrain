<template>
  <div class="flex items-center dark:bg-gray-800 justify-center">
    <div class="bg-gray-100 dark:bg-gray-700 rounded-sm hidden lg:flex">
      <img :src="employee.photo" class="object-cover object-center" alt="Profile">
      <div class="pl-4 pt-4">
        <p class="text-base font-bold leading-none dark:bg-gray-100 text-gray-700">
          {{ employee.name }}
        </p>
    ...
    <div class="flex flex-col bg-gray-100 dark:bg-gray-700 rounded-sm py-4 lg:hidden block">
      <div class="flex items-center px-4">
        <img :src="employee.photo" class="object-cover object-center h-20" alt="Profile">
        <div class="pl-4">
