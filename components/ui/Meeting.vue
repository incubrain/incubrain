  ...
  <div class="bg-gray-300 min-h-screen">
    <div class="flex items-center justify-center py-8 px-4">
      <div class="md:w-96 rounded-md shadow-lg py-4 px-5 w-full bg-white">
        ...
        <h1 class="text-lg font-bold text-gray-800 leading-5 pt-2">
          25th January, Monday
        </h1>
        <div class="pt-6 relative">
              ...
              <div class="absolute z-40 right-0">
                <div class="rounded bg-white shadow-xl">
                  <ul class="hidden mt-1">
                    <li class="hover:text-white cursor-pointer hover:bg-indigo-700 p-2">
                      Delete
                    </li>
                    <li class="hover:text-white cursor-pointer hover:bg-indigo-700 p-2">
                      Edit
          ...
          <p class="text-sm leading-none pt-2 text-gray-600">
            Meeting with stake holders
          </p>
          <p class="text-xs italic pt-1 leading-3 text-gray-400">
            Discussion on the template design
          </p>
          <div class="flex items-center justify-left">
            <div class="text-green-500 bg-green-200 py-1 px-2 rounded text-xs leading-3 mt-2">
              Completed
            </div>
          </div>
        </div>
        <div class="pt-6 relative">
          ...
          <div class="flex items-center justify-left">
            <div class="text-red-500 bg-red-200 py-1 px-2 rounded text-xs leading-3 mt-2">
              Pending
            </div>
          </div>
        </div>
