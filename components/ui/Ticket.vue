    ...
    <div class="cursor-pointer rounded-md shadow-lg bg-white dark:bg-gray-800 relative">
      <div class="py-5">
        <div class="px-6">
          ...
          <p class="text-sm leading-none text-justify text-gray-800 dark:text-gray-100 mt-1">
        ...
        <div class="mt-5 px-6 flex items-center text-gray-700 dark:text-gray-400">
          ...
          <p class="ml-2 text-xs leading-3 text-gray-600 dark:text-gray-400">
            Veevents.com/cosutmeparty
          </p>
          <p />
          <svg
            class="ml-3.5 cursor-pointer"
        ...
        <div class="pt-6 flex justify-between relative items-center w-full">
          <div class="w-3 h-5 dark:bg-gray-400 rounded-r-3xl" />
          <div class="w-full border-b-2 border-dashed border-gray-100 dark:border-gray-400" />
          <div class="w-3 h-5 dark:bg-gray-400 rounded-l-3xl" />
        </div>
        <div class="mt-4 px-6 flex flex-col w-full justify-center items-center">
          ...
          <p class="text-sm font-bold leading-none text-gray-700 dark:text-gray-400 mt-2">
            253704938890287467
          </p>
        </div>
      </div>
