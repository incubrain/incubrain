  ...
  <div class="bg-gray-300 min-h-screen">
    <div class="flex items-center justify-center py-8 px-4">
      <div class="md:w-96 rounded shadow-lg p-5 bg-white w-full">
        <h1 class="text-lg font-bold leading-3 text-gray-800">
          ...
          <div class="flex items-start justify-between">
            <div class="flex items-start">
              ...
              <div class="flex flex-col pl-2">
                <p class="text-sm font-semibold leading-3 text-gray-800">
                  Ending with 7562
                </p>
                <p class="text-xs leading-3 pt-2 text-gray-600">
                  CVV: 822 | Expiry: 07/2021
                </p>
              </div>
            </div>
            <p class="text-sm font-semibold leading-3 text-right text-gray-800">
              $12,300
            </p>
          </div>
        </div>
