<template>
  <div class="flex items-center justify-center w-full h-full">
    <div class="flex flex-col items-center py-6 pl-8 pr-8 bg-white dark:bg-gray-800 rounded h-full w-full">
      <img class="w-24 h-24 rounded-full shadow" src="https://i.ibb.co/h7tHKRm/Photo.png" alt="profile">
      <p class="text-xl font-semibold leading-tight mt-2.5 text-gray-800 dark:text-gray-100">
        Delia Jimenez
      </p>
      <p class="text-sm leading-3 mt-2 text-gray-500 dark:text-gray-400">
        Bulgaria
      </p>
      <div class="mt-7">
        <div class="flex items-center">
          <div>
            <p class="text-xl font-semibold leading-tight text-green-600">
              100,345
            </p>
            <p class="text-sm leading-3 mt-2 text-gray-500 dark:text-gray-400">
              Followers
          ...
          <div class="ml-11">
            <p class="text-xl font-semibold leading-tight text-blue-600">
              1,765
            </p>
            <p class="text-sm leading-3 mt-2 text-gray-500 dark:text-gray-400">
              Posts
        ...
        <div class="flex items-center mt-8">
          <button class="flex items-center justify-center px-5 py-3 border hover:bg-indigo-700 text-sm leading-none text-center text-indigo-700 dark:text-white dark:bg-indigo-700 hover:text-white rounded border-indigo-700 dark:hover:text-indigo-700 dark:hover:bg-white">
            Add to list
          </button>
