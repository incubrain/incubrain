<template>
  <div class="py-12 bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0 hidden" id="modalBilling">
...
export default {
  methods: {
      modalHandler(val) {
          let modal = document.getElementById("modalBilling");
          if (val) {
              this.fadeIn(modal);
          } else {
              this.fadeOut(modal);
