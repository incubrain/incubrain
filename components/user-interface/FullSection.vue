  ...
  <div class="w-full flex flex-col lg:flex-row bg-white dark:bg-gray-800 shadow rounded">
    ...
    <div class="w-full lg:w-1/3 flex-col flex justify-center items-center px-12 py-8">
      ...
      <div class="flex items-center">
        <svg
          class="cursor-pointer w-4 mr-1 text-yellow-400 icon icon-tabler icon-tabler-star"
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
          viewBox="0 0 24 24"
        ...
        <svg
          class="cursor-pointer w-4 text-gray-200 dark:text-gray-400 icon icon-tabler icon-tabler-star"
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
          viewBox="0 0 24 24"
