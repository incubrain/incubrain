<template>
  <div class="w-full flex flex-col lg:flex-row bg-white dark:bg-gray-800 shadow rounded">
    <div class="w-full lg:w-1/3 px-12 flex flex-col items-center py-10">
      ...
      <p class="text-gray-600 dark:text-gray-100 text-sm tracking-normal font-normal mb-8 text-center w-10/12">
        The more I deal with the work as something that is my own, as something that is personal, the more successful it
        is.
      </p>
      <div class="flex items-start">
        <div class="">
          ...
          <p class="text-gray-800 dark:text-gray-100 text-sm leading-5">
            Reviews
          </p>
        </div>
    ...
    <div
      ...
      <div class="flex items-start">
        <div class="bg-gray-200 text-gray-600 dark:text-gray-100 dark:bg-gray-700 rounded text-xs leading-3 py-2 px-3">
          Interface
        </div>
        <div
          class="bg-gray-200 text-gray-600 dark:text-gray-100 dark:bg-gray-700 rounded mx-2 text-xs leading-3 py-2 px-3">
          Interface
        </div>
        <div class="bg-gray-200 text-gray-600 dark:text-gray-100 dark:bg-gray-700 rounded text-xs leading-3 py-2 px-3">
          Interface
    ...
    <div class="w-full lg:w-1/3 flex-col flex justify-center items-center px-12 py-8">
      ...
      <div class="flex items-center">
        <svg class="cursor-pointer w-4 mr-1 text-yellow-400 icon icon-tabler icon-tabler-star"
        ...
        <svg class="cursor-pointer w-4 text-gray-200 dark:text-gray-400 icon icon-tabler icon-tabler-star"
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
          viewBox="0 0 24 24"
...
const image = 'https://tuk-cdn.s3.amazonaws.com/assets/components/grid_cards/gc_2.png'
