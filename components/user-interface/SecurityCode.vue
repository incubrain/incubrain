<template>
  <div id="modalSecurityCode" class="hidden py-12 dark:bg-black bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0">
    <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
      <div class="flex items-center justify-center py-8 px-4">
        <div class="relative md:w-96 rounded shadow-lg p-6 dark:bg-gray-800 bg-white">
          ...
          <p class="pb-6 text-sm pt-4 font-normal dark:text-gray-100 text-gray-600">
            Code generated, copy and paste to use
          </p>
          ...
          <div class="flex items-center justify-between">
            <button class="py-3.5 w-full text-white focus:outline-none hover:opacity-90 rounded border text-sm font-semibold border-indigo-700 bg-indigo-700">
              Copy Code
            </button>
          </div>
