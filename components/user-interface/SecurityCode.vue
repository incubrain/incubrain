<template>
      <div class="hidden py-12 dark:bg-black bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modalSecurityCode">
...
export default {
  methods: {
      modalHandler(val) {
          let modal = document.getElementById("modalSecurityCode");
          if (val) {
              this.fadeIn(modal);
          } else {
              this.fadeOut(modal);
