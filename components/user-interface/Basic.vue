<template>
  <div class="bg-white shadow rounded p-6">
    <div class="flex items-end">
      ...
      <p tabindex="0"
        class="focus:text-indigo-800 focus:outline-none text-sm leading-normal pl-44 cursor-pointer focus:underline text-right text-indigo-700">
        View all
      </p>
    </div>
    <div class="mt-6 flex">
      <div class="w-10 flex flex-col items-center">
        <img aria-label="boy avatar"
          tabindex="0"
          class="focus:outline-none h-10 rounded-full"
      ...
      <div class="pl-3">
        <p tabindex="0"
          class="focus:outline-none text-sm font-semibold leading-normal text-gray-800">
          John Stark
        </p>
        <p tabindex="0"
        ...
        <p tabindex="0"
          class="focus:outline-none pt-4 text-sm leading-4 text-gray-600">
    ...
    <div class="mt-6 flex">
      <div class="w-10 flex flex-col items-center">
        <img tabindex="0"
          alt="boy avatar"
          class="focus:outline-none unded-full"
    ...
    <div class="mt-6 flex">
      ...
      <div class="pl-3">
        ...
        <div class="py-4 flex items-center">
          ...
          <p tabindex="0"
            class="focus:outline-none text-xs leading-6 pl-2 text-indigo-700">
            Annual Report.docx
          </p>
        </div>

        <p tabindex="0"
          class="focus:outline-none text-sm leading-4 text-gray-600">
