  ...
  <div class="bg-gray-300 min-h-screen">
    <div class="flex items-center justify-center py-8 px-4">
      <div class="md:w-96 rounded-md shadow-lg p-5 bg-white">
        <h1 class="pt-2 pb-7 text-gray-800 font-bold text-lg">
          Recent Updates
        </h1>
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            ...
            <p class="text-gray-600 text-sm font-medium pl-3">
              Order# IDO-214-152
            </p>
          </div>
        ...
        <div class="flex items-center justify-between pt-5">
          <div class="flex items-center">
            ...
            <p class="text-gray-600 text-sm font-medium pl-3">
              New message from <span class="text-blue-500">@Kelly190</span>
            </p>
          </div>
        </div>
        <div class="flex items-center justify-between pt-5">
