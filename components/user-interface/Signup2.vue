<template>
  <div>
    <div id="modal" ref="modalSignup2" class="hidden py-12 dark:bg-black bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0">
      <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg flex justify-center">
        <div class="relative w-11/12 sm:w-8/12 md:w-10/12 bg-white dark:bg-gray-800 shadow rounded">
          ...
          <div class="md:px-10 py-4 px-5 md:py-6">
            <p class="text-2xl font-bold leading-normal text-gray-800 dark:text-gray-100">
              Sign up
            </p>
            <p class="text-sm leading-3 mt-4 mb-5 text-gray-600 dark:text-gray-300">
              Recieve a special discount from us!
            </p>
            <div>
            ...
            <div class="md:flex items-center justify-between mt-4 md:mt-6">
              <p class="text-xs leading-3 text-gray-600 dark:text-gray-300">
                Already have an account? <span class="cursor-pointer text-indigo-700 dark:text-indigo-600 underline font-semibold">Sign Up</span>
              </p>
