<template>
  <div class="p-12">
    <div class="flex items-center justify-center">
      <div class="w-full h-100 sm:px-6">
        <div
          class="
          px-4
          md:px-10
          ...
          <table class="w-full whitespace-nowrap">
            <thead>
              ...
              >
                ...
                <th class="font-normal text-left pl-16">
                  Members
                </th>
              </tr>
            </thead>
            <tbody class="w-full">
              ...
              >
                ...
                <td class="pl-12">
                  ...
                  <div class="w-24 h-3 bg-gray-100 rounded-full mt-2">
                    <div class="w-6 h-3 bg-green-progress rounded-full" />
                  </div>
                </td>
                <td class="pl-12">
                  <p class="font-medium">
              ...
              >
                ...
                <td class="pl-12">
                  ...
                  <div class="w-24 h-3 bg-gray-100 rounded-full mt-2">
                    <div class="w-8 h-3 bg-green-progress rounded-full" />
                  </div>
                </td>
                <td class="pl-12">
                  <p class="font-medium">
              ...
              >
                ...
                <td class="pl-12">
                  ...
                  <div class="w-24 h-3 bg-gray-100 rounded-full mt-2">
                    <div class="w-24 h-3 bg-green-progress rounded-full" />
                  </div>
                </td>
                <td class="pl-12">
                  <p class="font-medium">
              ...
              >
                ...
                <td class="pl-12">
                  ...
                  <div class="w-24 h-3 bg-gray-100 rounded-full mt-2">
                    <div class="w-14 h-3 bg-green-progress rounded-full" />
                  </div>
                </td>
                <td class="pl-12">
                  <p class="font-medium">
              ...
              >
                ...
                <td class="pl-12">
                  ...
                  <div class="w-24 h-3 bg-gray-100 rounded-full mt-2">
                    <div class="w-16 h-3 bg-green-progress rounded-full" />
                  </div>
                </td>
                <td class="pl-12">
                  <p class="font-medium">
              ...
              >
                ...
                <td class="pl-12">
                  ...
                  <div class="w-24 h-3 bg-gray-100 rounded-full mt-2">
                    <div class="w-12 h-3 bg-green-progress rounded-full" />
                  </div>
                </td>
                <td class="pl-12">
                  <p class="font-medium">
...
function setShow (n?: number): number | null {
  if (n) { show = n }
  return show
}
