<template>
  <div>
    <div id="modal" ref="modalCta" class="hidden py-12 dark:bg-black bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0">
      <div role="alert" class="container mx-auto w-full sm:w-11/12 md:w-2/3 max-w-lg flex justify-center px-4">
        <div class="relative w-96 bg-white dark:bg-gray-800 shadow px-4 md:px-8 py-8 bg-indigo-700 dark:bg-indigo-600 rounded">
          <p class="text-base sm:text-xl md:text-2xl font-bold leading-6 text-gray-100">
            Get in touch with us
          </p>
          <p class="md:w-10/12 text-xs sm:text-sm leading-5 text-gray-100 mt-2 md:mt-4 mb-4 md:mb-6">
            Get yourself ready for the whole new collection of premium and attractive products made just for you.
          </p>
          <div class="flex items-center text-xs font-medium leading-3 text-gray-100 pl-4 bg-white bg-opacity-50 dark:bg-indigo-800 dark:border-indigo-800 border border-white rounded">
            ...
            <button class="border-l py-2.5 px-4 focus:outline-none">
              Subscribe
            </button>
          </div>
