    ...
    <template v-slot:1>
      <div class="xl:mt-8">
        <div class="text-2xl main-heading lg:text-4xl xl:text-6xl text-gray-800 tracking-1px">
          ...
          <h2 class="mt-2 lg:mt-2 text-yellow-400">Drew MacGibbon</h2>
          <h2 class="mt-2 lg:mt-2">Call Me Mac</h2>
        </div>
        ...
        <div class="lg:w-1/2 relative bg-white rounded-md p-6 shadow-lg mt-6 mx-auto">
            <div class="absolute right-0 top-0 -mt-6">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="50" height="50">
                    <path fill="none" d="M0 0h24v24H0z"></path>
                    <path fill="blue" d="M19.417 6.679C20.447 7.773 21 9 21 10.989c0 3.5-2.457 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.247-5.621-.537.278-1.24.375-1.929.311-1.804-.167-3.226-1.648-3.226-3.489a3.5 3.5 0 0 1 3.5-3.5c1.073 0 2.099.49 2.748 1.179zm-10 0C10.447 7.773 11 9 11 10.989c0 3.5-2.457 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.247-5.621-.537.278-1.24.375-1.929.311C4.591 12.322 3.17 10.841 3.17 9a3.5 3.5 0 0 1 3.5-3.5c1.073 0 2.099.49 2.748 1.179z"></path>
                </svg>
            </div>
            <div class="flex items-center">
                <h2 class="text-base f-m-m ml-4 font-semibold text-black"> {{ quote.author}}</h2>
            </div>
            <p class="text-base f-m-m mt-3 text-black"> {{ quote.content }}</p>
        </div>
    </div>
  </template>
  <template v-slot:2>
    ...
    <div class="text-2xl main-heading lg:text-4xl xl:text-6xl text-gray-800 tracking-1px mx-auto">
          <h2 class="mt-8 lg:mt-8 text-center">👋, I'm Mac</h2>
    </div>
  </template>
 </GridCol2Even>
</template>
