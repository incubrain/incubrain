  ...
  <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8">
      ...
      <p class="text-gray-700 lg:text-sm lg:max-w-md">
        "Class is dead", says Foucault; however, according to Reicher, it is not so much class that is dead, but rather
        the absurdity, and some would say the paradigm, of class. However, the subject is interpolated into a
        postpatriarchialist dialectic theory that includes consciousness as a totality.
      </p>
    </div>
    <div class="grid gap-6 row-gap-5 lg:mb-6 xl:mb-8 lg:grid-cols-4 sm:row-gap-6 sm:grid-cols-2">
      <a href="/"
        ...
        <div
          ...
          <div
            ...
            <p class="text-sm tracking-wide text-gray-300">
              ...
              it was made: Who’s the subject and why is she smiling?
            </p>
          </div>
        </div>
      </a>
