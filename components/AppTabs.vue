              ...
              <div class="absolute w-full -mt-20 h-auto md:h-20 bg-gray-800">
                  <div class="md:hidden mt-8 -mb-1 bg-gray-200 w-full relative">
                    ...
                    <select
                      ...
                      class="focus:outline-none form-select block w-full p-3 border-t border-r border-gray-300 rounded-b text-gray-600 appearance-none bg-transparent relative z-10 cursor-pointer"
                    >
                    <option
