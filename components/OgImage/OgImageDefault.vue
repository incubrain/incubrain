...
<template>
  <div class="w-full h-full flex flex-col justify-center bg-[#020420]">
    ...
    <div class="w-[620px] pl-[100px]">
      <h1 class="w-[620px] m-0 text-[65px] font-semibold mb-4 text-white flex items-center">
        <span>{{ title.slice(0, 40) }}</span>
      </h1>
      <p class="text-[30px] text-[#E4E4E7] leading-tight">
