  ...
  <div class="w-ful">
    <div class="mx-auto container bg-white dark:bg-gray-800 shadow rounded">
      <div class="flex w-full pl-3 sm:pl-6 pr-3 py-5 items-center justify-between bg-blue-100 rounded-t">
        <h3 class="text-gray-800 font-bold text-base sm:text-xl">
          Jack and Jill Enterprise
        </h3>
        <button class="ml-0 sm:ml-6 bg-indigo-700 transition duration-150 ease-in-out focus:outline-none hover:bg-indigo-600 rounded text-white px-5 h-8 flex items-center text-sm">
          Create New
        </button>
      </div>
        ...
        <div class="w-full md:w-2/3 flex flex-col md:flex-row items-start md:items-center justify-end">
          ...
          <div class="flex flex-col w-full sm:w-1/2 md:ml-4 mt-3 md:mt-0">
            <div class="relative w-full">
              ...
              <label for="search" class="hidden text-gray-800 text-sm font-bold leading-tight tracking-normal mb-2" />
      ...
      <div class="w-full overflow-x-scroll xl:overflow-x-hidden">
        <table id="main-table" class="min-w-full bg-white dark:bg-gray-800 rounded border border-gray-300">
          <thead>
            <tr class="w-full bg-gray-100 dark:bg-gray-700 border-b border-gray-300">
              ...
              <th class="border-l border-gray-300 pl-4 whitespace-no-wrap w-32 first-dropdown cursor-pointer" onclick="dropdownFunction(this)">
                <div class="flex items-center justify-between relative">
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="cursor-pointer mr-3 text-gray-800 dark:text-gray-100 icon icon-tabler icon-tabler-chevron-down"
                    width="16"
                    height="16"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
              ...
              <td class="pl-4 pr-4 whitespace-no-wrap w-32">
                <div class="relative">
                  ...
                  <ul class="invisible z-10 bg-white transition duration-300 opacity-0 bg-white shadow rounded mt-2 w-48 py-1 absolute">
                    <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-gray-100 px-3 font-normal">
                      Edit Project
                    </li>
                    <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-gray-100 px-3 font-normal">
                      Delete Project
              ...
              <td colspan="9">
                <div class="flex items-stretch w-full border-b border-gray-300 dark:border-gray-200">
                  ...
                  <div class="w-full bg-white border-l border-gray-300 dark:bg-gray-800">
                    <h4 class="pl-10 w-full text-sm text-gray-800 dark:text-gray-100 py-3 bg-gray-100 dark:bg-gray-700">
                    ...
                    <div class="bg-white dark:bg-gray-800 px-8 py-6">
                      <div class="flex items-start">
                        <div class="w-1/3">
                          ...
                          <h5 class="text-gray-800 dark:text-gray-100 font-normal text-xs">
                            Jason Smith
                          </h5>
                        </div>
                        <div class="w-1/3">
                      ...
                      <div class="flex items-start mt-6">
                        ...
                        <div class="w-1/3">
                          ...
                          <h5 class="text-indigo-700 font-normal text-xs">
                            Saul Berenson & Nicholas Brody
                          </h5>
                        </div>
                      </div>
                      <hr class="my-6 border-t border-gray-300 w-full">
                      <h5 class="text-gray-600 dark:text-gray-400 text-xs mb-2 font-bold">
                        Message
                      </h5>
                      <p class="text-gray-800 dark:text-gray-100 font-normal text-xs w-3/5 leading-6">
    ...
    <div class="mx-auto container pt-8 flex justify-center sm:justify-end items-center">
      <a class="text-gray-600 mr-5 border-gray-200 border rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray" href="javascript: void(0)">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="dark:text-gray-100 icon icon-tabler icon-tabler-chevron-left"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          stroke-width="1.5"
      ...
      <p class="text-gray-800 dark:text-gray-100 fot-normal text-xs">
        Page
      </p>
      <label for="selectedPage" class="hidden" />
      ...
      <a class="text-gray-600 mx-5 border-gray-200 border rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray" href="javascript: void(0)">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="dark:text-gray-100 icon icon-tabler icon-tabler-chevron-right"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          stroke-width="1.5"
      ...
      <label for="selectedPage1" class="hidden" />
      ...
      <p class="-mt-1 text-gray-800 dark:text-gray-100 fot-normal text-xs">
        per page
      </p>
    </div>
  </div>
