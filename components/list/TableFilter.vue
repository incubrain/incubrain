<template>
  <div class="w-full">
        ...
        <div class="w-full lg:w-3/4 xl:w-2/3 flex flex-col lg:flex-row items-start lg:items-center justify-between">
          ...
          <div class="relative w-full lg:w-1/4 my-2 lg:my-0 cursor-pointer lg:mx-2 xl:mx-4 z-0 border focus:border-gray-800 border-gray-300 dark:border-gray-200 rounded p-2">
            <div class="z-0 w-10 px-2 absolute inset-0 m-auto z-0 border-l mr-0 flex items-center text-indigo-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="icon cursor-pointer icon-tabler icon-tabler-calendar-event"
                width="20"
                height="20"
                viewBox="0 0 24 24"
                stroke-width="1.5"
          ...
          <button class="focus:shadow-outline-gray border border-transparent w-auto lg:w-1/4 my-2 lg:my-0 lg:ml-2 xl:ml-4 bg-indigo-700 transition focus:outline-none focus:border-gray-800 focus:shadow-outline-gray duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-6 py-2 text-sm">
            Add Schedule
          </button>
        </div>
      </div>
        ...
        <table class="min-w-full bg-white dark:bg-gray-800 rounded">
          ...
          <tbody>
            <tr class="h-24 border-gray-300 border-t border-b hover:border-indigo-300 hover:shadow-md cursor-pointer transition duration-150 ease-in-out">
              ...
              <td class="pr-6">
                <div class="w-full flex justify-start items-center h-full">
                  <div class="bg-indigo-200 text-indigo-700 rounded-full text-sm leading-3 py-2 px-5">
                    New
                  </div>
                </div>
              </td>
              ...
              <td class="pr-8 text-right">
                <button class="bg-gray-200 transition duration-150 ease-in-out border border-transparent focus:outline-none focus:border-gray-800 focus:shadow-outline-gray hover:bg-gray-300 rounded text-indigo-700 px-5 py-1 text-sm">
                  Start Session
                </button>
              </td>
            </tr>
            <tr class="h-24 border-gray-300 border-b border-t hover:border-indigo-300 hover:shadow-md cursor-pointer transition duration-150 ease-in-out">
              ...
              <td class="pr-6">
                <div class="w-full flex justify-start items-center h-full">
                  <div class="bg-yellow-200 text-yellow-600 rounded-full text-sm leading-3 py-2 px-5">
                    Reg.
                  </div>
                </div>
              </td>
            ...
            <tr class="opacity-50 h-24 border-gray-300 border-b border-t hover:border-indigo-300 hover:shadow-md cursor-pointer transition duration-150 ease-in-out">
              ...
              <td class="pr-8 text-right">
                <button class="cursor-not-allowed bg-gray-200 transition duration-150 ease-in-out rounded text-gray-600 dark:text-gray-400 px-5 py-1 text-sm focus:outline-none">
                  Cancelled
                </button>
              </td>
            </tr>
            <tr class="h-24 border-gray-300 border-b border-t hover:border-indigo-300 hover:shadow-md cursor-pointer transition duration-150 ease-in-out">
              ...
              <td class="pr-6">
                <div class="w-full flex justify-start items-center h-full">
                  <div class="bg-transparent text-gray-800 dark:text-gray-100 border border-gray-300 rounded-full text-sm leading-3 py-2 px-5">
                    N/A
                  </div>
                </div>
              </td>
    ...
    <div class="mx-auto container pt-8 flex justify-center sm:justify-end items-center">
      ...
      <label for="totalPage" class="hidden" />
      ...
      <p class="-mt-1 text-gray-800 dark:text-gray-100 fot-normal text-base">
        per page
      </p>
    </div>
  </div>
