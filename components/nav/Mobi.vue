<template>
  ...
  <div class="text-center">
    <button
      ...
      focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none
...
onMounted(() => {
  ...
  drawer.value = document.getElementById('drawer-navigation')
})
