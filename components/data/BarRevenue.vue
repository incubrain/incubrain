      ...
      <div class="px-5">
        <div class="md:flex">
            ...
            <div class="md:flex items-center">
              ...
              <div class="flex items-center md:pt-0 pt-4">
                <div class="flex items-center">
                  <div class="w-3 h-3 bg-indigo-700 rounded-full" />
                  <p class="text-sm leading-none text-gray-500 dark:text-gray-400 pl-2">
                    Earning
                  </p>
                </div>
                <div class="flex items-center pl-5">
                  <div class="w-3 h-3 bg-yellow-400 rounded-full" />
                  <p class="text-sm leading-none pl-2 text-gray-500 dark:text-gray-400">
                    Expense
                  </p>
                </div>
              </div>
          ...
          <div class="md:border-l md:py-6 py-4 border-gray-200 md:w-1/4 h-full flex items-center flex-col">
            ...
            <p class="text-2xl font-medium leading-normal pt-10 text-center dark:text-gray-100 text-gray-800">
              $25,852
            </p>
            <p class="text-sm leading-none text-center pt-3 text-gray-500 dark:text-gray-400">
              Budget: 56,800
            </p>
            <div class="px-11 pt-8">
              <canvas id="barRevenue" width="130" />
            </div>
            <button class="text-sm mt-12 mb-6 font-medium leading-none text-center text-white py-2.5 px-5 rounded bg-indigo-700 hover:bg-indigo-600">
              Increase Budget
            </button>
          </div>
        </div>
