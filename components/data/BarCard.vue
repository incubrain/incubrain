      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
          <div class="flex items-center pr-4">
            <div class="w-3 h-3 bg-gradient-to-br from-red-300 to-purple-500 rounded-full" />
            <p class="text-xs font-semibold leading-3 dark:text-gray-100 text-gray-800 pl-1">
              new
            </p>
          </div>
          <div class="flex items-center">
            <div class="w-3 h-3 bg-gradient-to-tl from-yellow-300 to-red-400 rounded-full" />
            <p class="text-xs pl-1 font-semibold leading-3 dark:text-gray-100 text-gray-800">
              returning
            </p>
          </div>
        </div>
