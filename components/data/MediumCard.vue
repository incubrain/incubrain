  ...
  <div class="flex justify-center">
    <div class="max-w-2xl rounded shadow bg-white dark:bg-gray-800 py-6 pl-6 pr-12">
      <div class="flex items-center">
        <p class="text-lg md:pr-96 font-semibold leading-4 text-gray-800 dark:text-gray-100">
          Statistics
        </p>
        <p class="text-xs leading-3 pl-6 text-right text-gray-500 dark:text-gray-400">
          Updated 1 month ago
        </p>
      </div>
      <div class="md:flex items-center justify-between pt-8">
        <div class="flex items-center">
          ...
          <div class="pl-4">
            <p class="w-11 text-lg font-semibold leading-none text-gray-800 dark:text-gray-100">
              230k
            </p>
            <p class="w-8 text-xs leading-3 text-gray-500 pt-2 dark:text-gray-400">
              Sales
            </p>
          </div>
        </div>
