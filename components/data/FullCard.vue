          ...
          <div class="flex flex-col w-[160px] lg:w-[220px]">
            <div class="w-full flex justify-end">
              <div class="flex items-center">
                ...
                >
                  ...
                  <path d="M12 7.33334L8 3.33334" stroke="CurrentColor" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M4 7.33334L8 3.33334" stroke="CurrentColor" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <p tabindex="0" class="focus:outline-none text-xs leading-none text-green-700">
                  4.3%
                </p>
              </div>
            </div>
            <div class="mt-2.5">
              <div class="w-full h-1 bg-gray-200 rounded-full">
                <div class="w-1/2 h-1 bg-blue-500 rounded-full" />
              </div>
            </div>
          </div>
          <p tabindex="0" class="focus:outline-none mt-1.5 text-xs leading-3 text-gray-500">
            Yearly target
          </p>
        </div>
        <div class="w-full">
