  ...
  <div class="flex justify-center">
    <div class="max-w-sm rounded shadow bg-white dark:bg-gray-800 px-6 py-5">
      ...
      <div class="sm:flex items-center">
        <div>
          <p class="text-xl font-semibold leading-4 text-gray-800 dark:text-gray-100">
            Earning
          </p>
          <p class="text-xs leading-3 text-gray-500 dark:text-gray-400 pt-4 pb-1">
            This Month
          </p>
          <p class="text-base font-medium leading-none text-gray-800 dark:text-gray-100">
            $4055.56
          </p>
          <p class="w-44 text-xs leading-none text-gray-500 pt-5 dark:text-gray-400">
            68.2% more earnings than last month.
          </p>
        </div>

        <div class="sm:mt-0 mt-5 relative flex items-center jutsify-center">
          <canvas id="singleEarnings" width="110" height="110" />
          <div class="absolute flex items-center justify-center flex-col inset-0">
            <p class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-100">
              38%
            </p>
            <p class="text-xs font-medium leading-3 text-gray-500 dark:text-gray-400">
              Sales
            </p>
          </div>
        </div>
