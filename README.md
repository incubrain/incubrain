...
I ended up overestimating how much I could get done, external factors played a part, but I'm generally too optimistic with my estimates. because of this I have **UPDATED the below estimates** and set them as tasks for the future. I will track the development of each feature on the homepage.

##### I also adopted the use of **story points** for estimations:
...
- [ ] Authentication/ Authorization - Used for managing user permissions, login etc | est. 8 hour(s) | taken ***FIRST TIME USING***
...
- [ ] Write 4 Articles for each topic - frontend/backend/business/design/code/tech 2h per article | est. 3 hour(s) | taken
