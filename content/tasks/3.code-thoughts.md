...
visible_on: /code
type: thoughts
excerpt: When it comes to writing code, I'm always thinking 'why?' and 'who is this code for?'. Until I know the purpose of the code there's no point touching the keyboard. So much time is wasted writing sloppy code that needs refactoring, unessasary funtionality, overly complex code.. the list goes on. The book Clean Code by 'Uncle Bob' has been a great influence on my programing mindset, a summary is below.
...
This is a repost of a [GitHub summary](https://github.com/JuanCrg90/Clean-Code-Notes/blob/master/README.md)
