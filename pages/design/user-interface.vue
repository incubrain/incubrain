  ...
  <AppTabs :page-parent="'design'">
    ...
    <GridCol4>
      <template v-slot:1>
        ...
        <UserInterfaceUploadImage />
        <UserInterfaceReferral />
      </template>
      <template v-slot:2>
        <UserInterfaceBillingDetails />
        <UserInterfaceReview />
        <UserInterfaceReview2 />
        <UserInterfaceSecurityCode />
      </template>
      <template v-slot:3>
        <UserInterfaceCTA />
        <UserInterfaceCTA2 />
        <UserInterfaceSignup />
        <UserInterfaceSignup2 />
      </template>
      <template v-slot:4>
        <UserInterfaceDatePicker />
